...
if (isset($_POST['editpersonalid'], $_POST['editpersonalfile'], $_POST['editpersonalvalue'])) {
    ...
    $personalid = mysqli_real_escape_string($conn, $_POST['editpersonalid']);
    $personalField = mysqli_real_escape_string($conn, $_POST['editpersonalfile']);
    $personalValue = mysqli_real_escape_string($conn, $_POST['editpersonalvalue']);
