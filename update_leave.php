...
if (isset($_POST['editleaveid'], $_POST['editleavefile'], $_POST['editleavevalue'])) {
    ...
    $leaveid = mysqli_real_escape_string($conn, $_POST['editleaveid']);
    $leaveField = mysqli_real_escape_string($conn, $_POST['editleavefile']);
    $leaveValue = mysqli_real_escape_string($conn, $_POST['editleavevalue']);
