...
if (isset($_POST['editemploymentid'], $_POST['editemploymentfile'], $_POST['editemploymentvalue'])) {
    ...
    $id = mysqli_real_escape_string($conn, $_POST['editemploymentid']);
    $field = mysqli_real_escape_string($conn, $_POST['editemploymentfile']);
    $value = mysqli_real_escape_string($conn, $_POST['editemploymentvalue']);
